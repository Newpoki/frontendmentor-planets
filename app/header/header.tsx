...
export const Header = () => {
    ...
    return (
        <>
            <header className="flex h-[70px] items-center justify-between border-b-1 border-b-white/20 px-6 py-4 tablet:h-auto tablet:flex-col tablet:gap-10 tablet:py-8 desktop:flex-row desktop:py-0">
